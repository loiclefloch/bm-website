...
class ReactYoutubePlayer extends React.Component {
  ...
  static stateNames = {
    '-1': ReactYoutubePlayer.State.UNSTARTED,
    0: ReactYoutubePlayer.State.ENDED,
    1: ReactYoutubePlayer.State.PLAYING,
    2: ReactYoutubePlayer.State.PAUSED,
    3: ReactYoutubePlayer.State.BUFFERING,
    5: ReactYoutubePlayer.State.CUED
  };
  ...
  */
  ...
  render() {
    ...
    return (
      <div ref={(element) => { this.refViewport = element; }} style={style}>
